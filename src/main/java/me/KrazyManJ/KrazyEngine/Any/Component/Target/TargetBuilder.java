...
public final class TargetBuilder {
    ...
    public TargetBuilder(TargetSelectorVariable target) {
        this.selector = target;
    }

    public TargetBuilder setSelector(TargetSelectorVariable selector) {
    ...
    public TargetBuilder setXYZ(double x, double y, double z) {
        values.put("x", x);
        values.put("y", y);
        values.put("z", z);
        return this;
    ...
    public TargetBuilder setDistance(float distance) {
    ...
    public TargetBuilder setDistance(float distanceFrom, float distanceTo) {
        try {
            values.put("distance", new TargetRange(distanceFrom, distanceTo).toString());
        } catch (NonRangeTargetException e) {
            e.printStackTrace();
        }
        return this;
    }

    public TargetBuilder setVolume(double x, double y, double z) {
        values.put("dx", x);
        values.put("dy", y);
        values.put("dz", z);
        return this;
    ...
    public TargetBuilder addTag(String tag) {
        tagValues.add(tag);
        return this;
    }

    public TargetBuilder addTags(String... tags) {
        tagValues.addAll(List.of(tags));
        return this;
    }

    public TargetBuilder addTag(String tag, boolean bool) {
    ...
    public TargetBuilder setTeam(Team team) {
        values.put("team", team.getName());
        return this;
    }

    @Deprecated
    public TargetBuilder setTeam(String team) {
        values.put("team", team);
        return this;
    }

    public TargetBuilder setLimit(int limit) {
        values.put("limit", limit);
        return this;
    }

    public TargetBuilder setSortingPriority(SortSelection s) {
        values.put("sort", s.s());
        return this;
    }

    public TargetBuilder setExpLevel(int level) {
        values.put("level", level);
        return this;
    }

    public TargetBuilder setGamemode(GameMode mode) {
        values.put("gamemode", mode.name().toLowerCase());
        return this;
    }

    public TargetBuilder setGamemode(GameMode mode, boolean bool) {
    ...
    public TargetBuilder setName(String name, boolean bool) {
        values.put("name", (bool ? "" : "!") + name);
        return this;
    }

    public TargetBuilder setVerticalRotation(float degree) {
        values.put("x_rotation", new TargetRange(degree));
        return this;
    }

    public TargetBuilder setVerticalRotation(float degreeFrom, float degreeTo) {
        try {
            values.put("x_rotation", new TargetRange(degreeFrom, degreeTo).toString());
        } catch (NonRangeTargetException e) {
            e.printStackTrace();
        }
        return this;
    ...
    public TargetBuilder setHorizontalRotation(TargetRange degreeRange) {
        values.put("y_rotation", this);
        return this;
    }

    public TargetBuilder setType(EntityType type) {
        values.put("type", type.getKey().getKey());
        return this;
    }

    public TargetBuilder setType(EntityType type, boolean bool) {
        values.put("type", (bool ? "" : "!") + type.getKey().getKey());
        return this;
    }

    public TargetBuilder setNbt(String nbt) {
        values.put("nbt", nbt);
        return this;
    }
    // TODO: Advancement selector
    // TODO: By items selection
}
